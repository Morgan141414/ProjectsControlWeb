  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center h-full">
        <p className="text-[11px] font-bold text-white/50 uppercase tracking-[0.25em]">С возвращением,</p>
        ...
        <p className="mt-1.5 text-sm text-white/45 font-medium">Хорошего рабочего дня!</p>
      </div>
...
function SatisfactionRate() {
  ...
  return (
    <div className="vision-card flex flex-col items-center justify-center p-6">
      ...
      <p className="text-[11px] text-white/25 mb-5">По всем проектам</p>
      ...
      <p className="mt-4 text-[11px] text-white/25 font-medium">На основе отзывов</p>
    </div>
  )
}
  ...
  return (
    <div className="vision-card p-6">
      ...
      <div className="flex items-baseline gap-2 mb-5">
        ...
        <p className="text-xs text-white/25 font-medium">человек</p>
      </div>
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] p-3.5 text-center transition-all duration-300 hover:bg-white/[0.06] hover:border-white/[0.12] hover:shadow-lg hover:shadow-blue-500/5">
          <p className="text-[10px] text-white/25 mb-1 font-medium uppercase tracking-wider">Общий балл</p>
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] p-3.5 text-center transition-all duration-300 hover:bg-white/[0.06] hover:border-white/[0.12] hover:shadow-lg hover:shadow-purple-500/5">
          <p className="text-[10px] text-white/25 mb-1 font-medium uppercase tracking-wider">Приглашено</p>
          <p className="text-base font-bold text-white">1,465</p>
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      <div className="mb-5 flex items-center justify-between">
        <h3 className="text-lg font-black text-white tracking-tight">Таблица проверки</h3>
...
function ActiveUsersChart() {
  ...
  const activeStats = [
    { label: 'Пользователи', value: '32,984', icon: Users, gradient: 'linear-gradient(135deg, #0075FF, #00D1FF)', shadow: 'rgba(0,117,255,0.3)' },
    { label: 'Клики', value: '2,42m', icon: MousePointerClick, gradient: 'linear-gradient(135deg, #01B574, #00F0FF)', shadow: 'rgba(1,181,116,0.3)' },
    { label: 'Продажи', value: '2,400$', icon: DollarSign, gradient: 'linear-gradient(135deg, #7551FF, #C851FF)', shadow: 'rgba(117,81,255,0.3)' },
    { label: 'Объекты', value: '320', icon: Box, gradient: 'linear-gradient(135deg, #FFB547, #FF6B35)', shadow: 'rgba(255,181,71,0.3)' },
  ]
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-white/25 mb-5">
        (<span className="font-bold text-[#01B574]" style={{ textShadow: '0 0 8px rgba(1,181,116,0.3)' }}>+23%</span>) по сравнению с прошлой неделей
      </p>
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3 mb-5">
          ...
          <h3 className="text-lg font-black text-white tracking-tight">Организация</h3>
        </div>
        <p className="text-sm font-semibold text-white/60">{orgName}</p>
        {orgCode && (
          <div className="mt-4 flex items-center gap-2">
            <span className="text-[11px] text-white/25 font-medium uppercase tracking-wider">Код:</span>
            <span
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            >
              {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Вступить'}
            </button>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-5">
        ...
        <h3 className="text-lg font-black text-white tracking-tight">Задачи на сегодня</h3>
      </div>
      ...
      {!orgId ? (
        <div className="flex flex-col items-center justify-center py-10 text-center">
          ...
          <p className="text-sm text-white/25 font-medium">Сначала присоединитесь к организации</p>
        </div>
      ) : loading ? (
        <div className="flex flex-col items-center justify-center py-10">
          ...
          />
          <p className="text-sm text-white/25 font-medium">Загрузка...</p>
        </div>
      ) : tasks.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 text-center">
          <div
          ...
          <p className="text-sm text-white/25 font-medium">Нет задач на сегодня</p>
        </div>
      ) : (
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-lg font-black text-white tracking-tight">Дневной отчёт</h3>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          >
            <option value="" style={{ background: '#060B26' }}>Выберите проект</option>
            {projects.map((p) => (
